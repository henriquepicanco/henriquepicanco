# 👋 Olá, eu sou Henrique Picanço

Estudante de **Análise e Desenvolvimento de Sistemas** (UNINTER - 1/5), já tenho uma graduação em **Jornalismo** pela UNICARIOCA (👨‍🎓 2022). Com experiência em várias áreas, entre elas varejo e educação, na tecnologia tenho conhecimentos em *full-stack*, principalmente na criação de sites em WordPress do VPS ao site no ar, passando pela programação do site e manutenção do servidor. Do meu lado jornalista, tenho experiência em redação para a web e gerenciamento de redes sociais.
